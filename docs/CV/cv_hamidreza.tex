...
\\
\begin{footnotesize}
{\it {\textcolor{Black!70}{\bf Ongoing Courses:}} (CSC2541)} Topics in Machine Learning: Introduction to Causality, {\it (CSC2240)} Graphs, Matrices, and Continuous Optimization, {\it (CSC2701)} Communication for Computer Scientists
\end{footnotesize}
\\
\\
